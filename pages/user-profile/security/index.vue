            ...
            <div class="box-user-oprofile mt--2">
                <v-row justify="center mt-15">
                    ...
                    <v-col cols="12" class="mt-10">
                        <v-row justify="center">
                            <v-col cols="2">
                                <div class="user-info-menu mt-4" @click="$router.push('/user-profile/user-info')">
                                ...
                                <div class="user-info-menu-active mt-7" @click="$router.push('/user-profile/security')">
                            ...
                            <v-col cols="7">
                                <div class="user-info-box pt-10 px-3" id="userInfoBox">
                                    <v-row justify="center" align="center" class="py-10 ">
                                        ...
                                        <v-col cols="8">
                                            <div>
                                                <v-text-field background-color="#4F4F4F" dense outlined hide-details
                                                    color="#D9D9D9">
                                                    <template #label>
                                                        <span class="Grey2--text t14400">Password</span>
                                                    </template>
                                        ...
                                        <v-col cols="12">
                                            <v-row justify="end" class="py-3 px-10">
