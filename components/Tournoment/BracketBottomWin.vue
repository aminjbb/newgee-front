<template>
    ...
    left: -14px;">
            ...
            <span class="name  t14400">Orlando Jetsetters</span>
            <span class="score t14400">2</span>
        </div>
    ...
    left: -14px;">
            ...
            <span class="name success--text t14400">D.C. Senators</span>
            <span class="score success--text t14400">1</span>
        </div>
